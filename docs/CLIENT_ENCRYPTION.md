...
This guide explains how to encrypt secrets on the client side using quantum-resistant ML-KEM-1024 encryption before sending them to the Wulong TEE service.

## Overview

**Architecture:**
```
Client (Browser/Node)          Wulong TEE Service
        |                              |
        |--1. Get attestation--------->|
        |<--   + ML-KEM public key-----|
        |                              |
